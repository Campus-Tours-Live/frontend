...
// and the bff session's currentRole switch are two independent calls. These tests cover the case
...
describe("ParticipantOnboardingForm — onboarding-OK, session-init failed", () => {
  it("shows a session-init error (not a save failure), never re-submits, and is retryable", async () => {
    ...
    setCurrentRoleMutateAsync.mockResolvedValueOnce({ currentRole: "PARTICIPANT" });
