...
- [x] T7 S7 warning direction — 13ab5e3 (995 green). !coversAvailability = !(before subset-of after) by interval coverage; 3 tests incl same-size swap. 8a: windowsEqual DELETED (only that caller).
- [ ] T8 minors 8b-8g
